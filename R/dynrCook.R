...
dynr.cook <- function(dynrModel, conf.level=.95, infile, optimization_flag=TRUE, hessian_flag = TRUE, verbose=TRUE, weight_flag=FALSE, debug_flag=FALSE, ...) {
    ...
    if(saem==TRUE){
		...
		# temprarily put the values from matlab in SAEMTesting here
		#par_value <- c(2.7566, 0.3857, 0.4193, -0.0019, -0.0052, -0.0009, 0.6994, 1.1974, -0.6781, -0.6877, -0.6655, -0.1761)
		#b <- matrix(c(0.691,0.172,0.750,0.755,-0.250,0.531,0.637,1.112,-0.107,2.918,1.641,-0.249,-0.021,0.444,0.979,0.696,0.321,-0.161,0.665,-0.511,-0.120,0.418,-0.114,0.078,0.764,0.982,0.861,0.461,0.522,1.502,0.174,0.531,1.280,1.783,0.779,1.412,-0.306,2.102,-0.221,0.650,-0.282,0.610,0.902,-0.061,-0.038,0.290,0.542,1.507,0.632,0.565,0.394,2.090,-0.152,-0.013,1.334,2.064,0.114,0.685,0.729,1.458,0.766,-0.380,0.753,0.847,1.442,2.484,0.697,1.091,0.496,0.184,-0.249,0.447,0.998,0.038,1.500,0.432,1.155,0.417,-0.127,0.240,-0.356,1.291,0.616,0.163,-0.070,-1.011,0.673,-0.148,0.744,1.157,1.262,1.035,0.476,1.923,0.692,-0.104,0.782,0.182,-0.469,1.136,0.132,0.314,0.015,0.051,-0.343,-0.086,0.990,0.589,1.217,1.057,-0.020,0.521,0.043,0.209,0.610,0.276,2.698,-0.289,0.815,1.453,0.527,0.384,-0.257,1.145,0.717,0.270,-1.200,1.218,0.849,0.906,-0.152,0.652,0.812,1.143,-0.129,-0.383,0.366,1.241,0.391,-0.030,0.051,1.108,1.318,0.259,0.420,-0.029,0.058,1.285,-0.040,2.449,0.202,1.002,0.330,0.383,2.100,0.672,1.088,0.684,-0.583,0.860,0.368,1.271,1.208,-0.024,-0.267,1.185,1.986,-0.218,2.036,0.010,1.162,0.682,0.609,0.468,0.762,-0.003,0.918,0.694,0.798,0.999,1.013,1.600,-0.233,0.304,0.321,-0.617,0.170,0.293,0.606,2.471,0.412,0.651,0.426,0.891,0.710,0.367,0.716,1.816,-0.088,-0.048),nrow=num.subj, ncol=length(random.names))
