...
# call: the LHS of the equation in the type of call
# b: the RHS of the equation in the type of value
# known.vars: the list of know variables (e.g., list(var1= 1, var2 = 2))
# There may be multiple variables in call, 
# but there must be at most one unknown variables in call 
...
# given the ldl matrix generated by symbolicLDLDecomposition, and its values from dynr interface, obtain the value of pars
symbolicReverseLDL <- function(ldl, values.ldl){
  known.vars <- list()
  #browser()
