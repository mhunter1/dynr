---
title: "Tutorial on Fitting Regime-Switching ODE using *dynr*"
author: "Sy-Miin Chow"
...
## Load library and format data

```{r}
require(dynr)
thedata = read.table('/Users/symiin/Dropbox/Symiin_Lu/dynr/data/New2CovModel1T1000n20batch1ODEsimData.txt')
...
model <- dynr.model(
              ...
              options=list(maxtime=1*60, maxeval=5)
)
```
