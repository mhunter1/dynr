...
# x1 and x2 are two auxiliary varialbes used in the generation of two covariates.
...
dynrModel <- dynr.model(dynamics=dynm, measurement=meas,
...
result = dynr.mi(dynrModel, which.aux=c("x1","x2"), 
