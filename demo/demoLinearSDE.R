...
# Author: Lu Ou
# Date: 2016-02-22
# Filename: demoLinearSDE.R
# Purpose: Create and test an example of Linear SDE models (i.e., 
# a damped linear oscillator with dynamic noise). This example is adapted from
# Example 2 in StateSpaceContinuous.R in the OpenMx package written by 
# Michael D. Hunter.
#------------------------------------------------------------------------------
